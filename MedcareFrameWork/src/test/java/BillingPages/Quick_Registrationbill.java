...
public class Quick_Registrationbill
{

	//WebDriver driver=null; 
	WebDriver driver; 
	public Quick_Registrationbill(WebDriver driver) 
	{
		this.driver=driver;
	...
	{   
		...
		Assert.assertEquals(Actual_1, Expected_1, "Patient has been created ");
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//Register_a_patient_for_Reminder_flow.png"+dateFormat.format(date)));  
		*/	
		Thread.sleep(5000);
