...
public class Reschedule_Existing_Appointment_against_Doctor 
{
	...
	{
		Reschedule_existing_appointment_against_doctor_Quick_Registration QuickReg=new Reschedule_existing_appointment_against_doctor_Quick_Registration (driver);
