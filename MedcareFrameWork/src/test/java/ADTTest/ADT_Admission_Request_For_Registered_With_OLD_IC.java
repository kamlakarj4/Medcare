...
public class ADT_Admission_Request_For_Registered_With_OLD_IC 
{
	...
	{
		ADTpages.Quick_Registration_With_OLD_IC  QuickReg=new ADTpages.Quick_Registration_With_OLD_IC(driver);
	...
	{
		ADTpages.ADTRequestForm_For_Registred_with_OLD_IC  ADT=new ADTpages.ADTRequestForm_For_Registred_with_OLD_IC (driver);
