...
public class ADT_Admission_Request_For_Registered_With_Passort 
{
	...
	{
		ADTpages.Quick_Registration QuickReg=new ADTpages.Quick_Registration (driver);
	...
	{
		ADTpages.ADTRequestForm_For_Registred_with_Passport ADT=new ADTpages.ADTRequestForm_For_Registred_with_Passport(driver);
