...
public class OPD_ExistingRegWithNRIC
{
	...
	{	  
		...
		{
			System.out.println("Patient has been selected successfully for primary id New IC "); 
		} else 
		{
			System.out.println("Patient has been not selected for primary id New IC"); 
		}


		File screenshot4 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot4, new File(".//ScreenShots//Patient has been selected for primary id  New IC.png"));
