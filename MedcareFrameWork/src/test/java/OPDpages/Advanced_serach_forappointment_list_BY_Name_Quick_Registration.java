...
public class Advanced_serach_forappointment_list_BY_Name_Quick_Registration 
{

	WebDriver driver=null; 
	public Advanced_serach_forappointment_list_BY_Name_Quick_Registration(WebDriver driver) 
	{
		this.driver=driver;
