...
public class OPD_Registration_With_Primary_ID_NEW_IC
{
	...
	{	  
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//OPDRegistrationWithNewIC.png"));
