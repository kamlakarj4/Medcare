...
public class Quick_Registration_For_Existing_Patient_with_Army 
{
	...
	public void Quick_Registration_With_Existing_With_Army(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar) throws InterruptedException, IOException 
	{
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//Fill details_for_Quick registertaion existing patient with primary id army.png")); 
		...
		if(driver.getPageSource().contains("Army"))
		{
			System.out.println("Quick registertaion existing patient with primary id army has been selected"); 
		} else 
		{
			System.out.println("Quick registertaion existing patient with primary id army not selected!!!"); 
		}

		Thread.sleep(1000);

		File screenshot2 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot2, new File(".//ScreenShots//Quick_registeration_with_primary_id_army_selected.png"));  
		...
		/*
		 * //Gender2 Thread.sleep(500); driver.findElement(Genderclick2).click();
		 * Thread.sleep(500); driver.findElement(AllDropDownSearch).sendKeys("MALE");
		 * Thread.sleep(500); driver.findElement(Genderselectvalue2).click();
		 */
		...
		{
			System.out.println("Quick registertaion existing patient with primary id army has been created and sercahed succesfully"); 
		}
		else 
		{
			System.out.println(EnterPatientName+"Quick registertaion existing patient with primary id army not fount!!!"); 
		}
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//Quick_registeration_has_been_created_with_primary_id_army.png"));  
