...
public class OPD_ExistingRegWithPAN
{
	...
	{	  
		...
		Thread.sleep(5000);
		if(driver.getPageSource().contains("PAN")) 
		{
			System.out.println("Patient has been selected successfully for primary id PAN "); 
		} else 
		{
			System.out.println("Patient has been not selected for primary id PAN"); 
		}


		File screenshot4 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot4, new File(".//ScreenShots//Patient has been selected for primary id PAN.png"));
