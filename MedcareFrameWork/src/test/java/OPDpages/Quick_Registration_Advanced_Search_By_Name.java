...
public class Quick_Registration_Advanced_Search_By_Name 
{
	...
	public void Quick_Registration_Advanced_Search_Name() throws InterruptedException, IOException 
	{
	...
	//	Thread.sleep(5000);
		...
		Thread.sleep(2000);
		driver.findElement(NameFieldClick).sendKeys(EnterPatientName);
