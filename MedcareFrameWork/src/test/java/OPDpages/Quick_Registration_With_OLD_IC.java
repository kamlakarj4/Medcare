...
public class Quick_Registration_With_OLD_IC 
{
	...
	//	driver.findElement(DOBclick).sendKeys(QuickDateOfBirthPar);
		...
		FileUtils.copyFile(screenshot2, new File(".//ScreenShots//QuickRegwithOLDIC.png"));
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//QuickRegEncounterListOLDIC.png"));
