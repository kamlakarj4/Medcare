...
public class Quick_Registration_For_Existing_Patient_with_NewIC 
{
	...
	public void Quick_Registration_With_Existing_With_NewIC(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar) throws InterruptedException, IOException 
	{
		...
		if(driver.getPageSource().contains("New IC"))
		{
			System.out.println(EnterPatientName+" "+"Quick registertaion existing patient with primary id NEWIC has been created and sercahed succesfully"); 
		} else 
		{
			System.out.println("Quick registertaion existing patient with primary id NEWIC not fount!!!"); 
		}
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//Quick_registeration_has_been_created_with_primary_id_NEWIC.png"));  
	   ...
	   // Thread.sleep(500);
		...
		FileUtils.copyFile(screenshot4, new File(".//ScreenShots//Quick_registeration_has_been_created_with_primary_id_NEWIC.png"));  
