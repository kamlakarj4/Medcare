...
public class OPD_ExistingRegWithAadhar
{
	...
	{	  
		...
		FileUtils.copyFile(screenshot2, new File(".//ScreenShots//QuickRegisteration.png")); 
		...
		Thread.sleep(5000);
		if(driver.getPageSource().contains("Aadhaar Card")) 
		{
			System.out.println("Patient has been selected successfully for primary id Aadhaar Card "); 
		} else 
		{
			System.out.println("Patient has been not selected for primary id Aadhaar Card"); 
		}


		File screenshot4 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot4, new File(".//ScreenShots//Patient has been selected for primary id addhar card.png"));
