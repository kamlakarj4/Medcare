...
public class New_Registration_Encounter_creation_OP_Bill_Search_patient_Add_charge_Final_Bill_Multiple_Payment_Method_Full_settlement {
	...
	public void startBrowser() throws ATUTestRecorderException 
	{
		...
		SimpleDateFormat dateFormat = new SimpleDateFormat("yy-MM-dd HH-mm-ss");
		Date date = new Date();
		recorder = new ATUTestRecorder(".//Videos//","New_Registration_Encounter_creation_OP_Bill_Search_patient_Add_charge_Final_Bill_Multiple_Payment_Method_Full_settlement -"+dateFormat.format(date),false);
		recorder.start();  
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failed_New_Registration_Encounter_creation_OP_Bill_Search_patient_Add_charge_Final_Bill_Multiple_Payment_Method_Full_settlement"+ dateFormat.format(date)));
		}
	}
