...
public class Reminder_Letter_Pending_Aging_Due_30_60_Dispatch 
{
	...
	@Test(priority=3)
	public void TC_03_Verify_Reminder_Letter_Pending_Aging_Due_30_60_Dispatch() throws InterruptedException, IOException, AWTException
	{
		BillingPages.Reminder_Letter_Pending_Aging_Due_30_60_Dispatch dueall= new BillingPages.Reminder_Letter_Pending_Aging_Due_30_60_Dispatch(driver);
		dueall.Reminder_Letter_Pending_Aging_Due_30_60_Dispatch_func();	
	}
	...
	public void startBrowser() throws ATUTestRecorderException 
	{
		...
		SimpleDateFormat dateFormat = new SimpleDateFormat("yy-MM-dd HH-mm-ss");
		Date date = new Date();
		recorder = new ATUTestRecorder(".//Videos//","Reminder_Letter_Pending_Aging_Due_30_60_Dispatch -"+dateFormat.format(date),false);
		recorder.start();  
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failed_Reminder_Letter_Pending_Aging_Due_30_60_Dispatch_func"+ dateFormat.format(date)));
		}
	}
